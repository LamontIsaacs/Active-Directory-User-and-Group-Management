...
## What I Did
In this lab, I simulated a real-world IT environment by:

- Creating Organizational Units (OUs) for Employees
- Creating and managing user accounts
- Creating security groups (HR, IT, Employees)
- Assigning users to groups based on roles
- Demonstrating access control structure
...
![Step1](screenshots/01-ad-users-and-computers.png)

---

### 2. Employees OU Created

![Step2](screenshots/02-employees-ou-created.png)

---

### 3. User Creation Form

![Step3](screenshots/03-user-form-filled.png)

---

### 4. User Successfully Added to Employees Organization Unit

![Step4](screenshots/04-user-in-employees-ou.png)

---

### 5. All Users Created

![Step5](screenshots/05-all-users-created.png)
